...
public class MomoConfigs {
    ...
    public static final String REDIRECT_URL = "http://localhost:3000/payment-return";//Thay bang react
    public static final String IPN_URL = "https://27ed-2001-ee0-4f81-fce0-f504-f239-a616-2aa3.ngrok-free.app/SpringMVC_Health_Schedule/api/payment/momo/ipn";//IPN do momo tu dong goi khi thanh toan xong
