...
public class ReviewServiceImpl implements ReviewService {
    ...
    public Review addReview(Map<String, String> params, Principal principal) {
        ...
        Review addedReview = this.reviewRepository.addReview(review);
        //Cap nhat danh gia cua bac si
        Double avgRatingDouble = reviewRepository.getAVGRatingDoctorReview(doctor.getDoctorId());//Lay danh gia
        ...
        DoctorRepository.updateDoctorRating(doctor);
        return addedReview;
    }
    ...
    @Override
    public Double getAVGRatingDoctor(int doctorId) {
        return this.reviewRepository.getAVGRatingDoctorReview(doctorId);
    }
}
